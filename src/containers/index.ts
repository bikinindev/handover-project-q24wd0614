...
export { default as RevolutionaryConveyor } from './RevolutionaryConveyor';

export { default as OurPartnerScreen } from './OurPartnerScreen'

export { default as BannerScreen3} from './BannerScreen3';
